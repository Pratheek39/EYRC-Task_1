...
static const _Color_type_support_symbol_names_t _Color_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eyantrasim_msgs, msg, Color)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eyantrasim_msgs, msg, Color)),
  }
};
...
{
  return &::eyantrasim_msgs::msg::rosidl_typesupport_cpp::Color_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, eyantrasim_msgs, msg, Color)() {
  return get_message_type_support_handle<eyantrasim_msgs::msg::Color>();
}
