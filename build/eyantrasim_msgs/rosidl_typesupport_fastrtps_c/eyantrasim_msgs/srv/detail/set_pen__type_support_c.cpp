...
#include "eyantrasim_msgs/srv/detail/set_pen__rosidl_typesupport_fastrtps_c.h"
...
using _SetPen_Request__ros_msg_type = eyantrasim_msgs__srv__SetPen_Request;
...
size_t get_serialized_size_eyantrasim_msgs__srv__SetPen_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetPen_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eyantrasim_msgs__srv__SetPen_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eyantrasim_msgs
size_t max_serialized_size_eyantrasim_msgs__srv__SetPen_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eyantrasim_msgs__srv__SetPen_Request;
    is_plain =
      (
...
static size_t _SetPen_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eyantrasim_msgs__srv__SetPen_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eyantrasim_msgs, srv, SetPen_Request)() {
...
using _SetPen_Response__ros_msg_type = eyantrasim_msgs__srv__SetPen_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eyantrasim_msgs
size_t get_serialized_size_eyantrasim_msgs__srv__SetPen_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPen_Response__ros_msg_type * ros_message = static_cast<const _SetPen_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_eyantrasim_msgs__srv__SetPen_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eyantrasim_msgs
size_t max_serialized_size_eyantrasim_msgs__srv__SetPen_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = eyantrasim_msgs__srv__SetPen_Response;
    is_plain =
      (
...
static size_t _SetPen_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eyantrasim_msgs__srv__SetPen_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eyantrasim_msgs, srv, SetPen_Response)() {
...
// already included above
// #include "eyantrasim_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "eyantrasim_msgs/srv/set_pen.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eyantrasim_msgs, srv, SetPen)() {
