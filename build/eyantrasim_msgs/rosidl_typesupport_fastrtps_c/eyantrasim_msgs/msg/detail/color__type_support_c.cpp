...
#include "eyantrasim_msgs/msg/detail/color__rosidl_typesupport_fastrtps_c.h"
...
using _Color__ros_msg_type = eyantrasim_msgs__msg__Color;
...
size_t get_serialized_size_eyantrasim_msgs__msg__Color(
  const void * untyped_ros_message,
...
static uint32_t _Color__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eyantrasim_msgs__msg__Color(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eyantrasim_msgs
size_t max_serialized_size_eyantrasim_msgs__msg__Color(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eyantrasim_msgs__msg__Color;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
static size_t _Color__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eyantrasim_msgs__msg__Color(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eyantrasim_msgs, msg, Color)() {
