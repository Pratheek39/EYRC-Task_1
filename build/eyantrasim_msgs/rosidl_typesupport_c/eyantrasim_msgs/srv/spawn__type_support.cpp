...
static const _Spawn_Request_type_support_symbol_names_t _Spawn_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eyantrasim_msgs, srv, Spawn_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eyantrasim_msgs, srv, Spawn_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, eyantrasim_msgs, srv, Spawn_Request)() {
  return &::eyantrasim_msgs::srv::rosidl_typesupport_c::Spawn_Request_message_type_support_handle;
}
...
static const _Spawn_Response_type_support_symbol_names_t _Spawn_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eyantrasim_msgs, srv, Spawn_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eyantrasim_msgs, srv, Spawn_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, eyantrasim_msgs, srv, Spawn_Response)() {
  return &::eyantrasim_msgs::srv::rosidl_typesupport_c::Spawn_Response_message_type_support_handle;
}
...
static const _Spawn_type_support_symbol_names_t _Spawn_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eyantrasim_msgs, srv, Spawn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eyantrasim_msgs, srv, Spawn)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, eyantrasim_msgs, srv, Spawn)() {
  return &::eyantrasim_msgs::srv::rosidl_typesupport_c::Spawn_service_type_support_handle;
}
