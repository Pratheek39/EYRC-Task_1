...
#include "eyantrasim_msgs/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eyantrasim_msgs::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eyantrasim_msgs::msg::Pose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eyantrasim_msgs::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eyantrasim_msgs::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eyantrasim_msgs::msg::Pose *>(
    untyped_ros_message);
...
{
  return &eyantrasim_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eyantrasim_msgs, msg, Pose)() {
  return &eyantrasim_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
