...
#include "eyantrasim_msgs/msg/detail/color__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eyantrasim_msgs::msg::Color;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const eyantrasim_msgs::msg::Color *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eyantrasim_msgs::msg::Color *>(
    untyped_ros_message);
...
{
  return &eyantrasim_msgs::msg::typesupport_fastrtps_cpp::_Color__handle;
}
