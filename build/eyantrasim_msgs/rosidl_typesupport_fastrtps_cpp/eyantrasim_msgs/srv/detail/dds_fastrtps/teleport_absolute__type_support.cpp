...
#include "eyantrasim_msgs/srv/detail/teleport_absolute__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eyantrasim_msgs::srv::TeleportAbsolute_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eyantrasim_msgs::srv::TeleportAbsolute_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eyantrasim_msgs::srv::TeleportAbsolute_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eyantrasim_msgs::srv::TeleportAbsolute_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eyantrasim_msgs::srv::TeleportAbsolute_Request *>(
    untyped_ros_message);
...
{
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_TeleportAbsolute_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eyantrasim_msgs, srv, TeleportAbsolute_Request)() {
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_TeleportAbsolute_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_eyantrasim_msgs
cdr_serialize(
  const eyantrasim_msgs::srv::TeleportAbsolute_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eyantrasim_msgs::srv::TeleportAbsolute_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = eyantrasim_msgs::srv::TeleportAbsolute_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eyantrasim_msgs::srv::TeleportAbsolute_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<eyantrasim_msgs::srv::TeleportAbsolute_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_TeleportAbsolute_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eyantrasim_msgs, srv, TeleportAbsolute_Response)() {
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_TeleportAbsolute_Response__handle;
}
...
{
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_TeleportAbsolute__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eyantrasim_msgs, srv, TeleportAbsolute)() {
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_TeleportAbsolute__handle;
}
