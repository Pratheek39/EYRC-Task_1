...
#include "eyantrasim_msgs/srv/detail/spawn__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eyantrasim_msgs::srv::Spawn_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eyantrasim_msgs::srv::Spawn_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eyantrasim_msgs::srv::Spawn_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eyantrasim_msgs::srv::Spawn_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eyantrasim_msgs::srv::Spawn_Request *>(
    untyped_ros_message);
...
{
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_Spawn_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eyantrasim_msgs, srv, Spawn_Request)() {
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_Spawn_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_eyantrasim_msgs
cdr_serialize(
  const eyantrasim_msgs::srv::Spawn_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: name
  cdr << ros_message.name;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eyantrasim_msgs::srv::Spawn_Response & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = eyantrasim_msgs::srv::Spawn_Response;
    is_plain =
      (
      offsetof(DataType, name) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const eyantrasim_msgs::srv::Spawn_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<eyantrasim_msgs::srv::Spawn_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_Spawn_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eyantrasim_msgs, srv, Spawn_Response)() {
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_Spawn_Response__handle;
}
...
{
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_Spawn__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eyantrasim_msgs, srv, Spawn)() {
  return &eyantrasim_msgs::srv::typesupport_fastrtps_cpp::_Spawn__handle;
}
