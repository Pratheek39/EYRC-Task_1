...
bool eyantrasim_msgs__srv__set_pen__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eyantrasim_msgs.srv._set_pen.SetPen_Request", full_classname_dest, 43) == 0);
  }
  eyantrasim_msgs__srv__SetPen_Request * ros_message = _ros_message;
  {  // r
...
PyObject * eyantrasim_msgs__srv__set_pen__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eyantrasim_msgs.srv._set_pen");
...
ROSIDL_GENERATOR_C_EXPORT
bool eyantrasim_msgs__srv__set_pen__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eyantrasim_msgs.srv._set_pen.SetPen_Response", full_classname_dest, 44) == 0);
  }
  eyantrasim_msgs__srv__SetPen_Response * ros_message = _ros_message;
