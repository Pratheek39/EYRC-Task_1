...
bool eyantrasim_msgs__srv__spawn__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eyantrasim_msgs.srv._spawn.Spawn_Request", full_classname_dest, 40) == 0);
  }
  eyantrasim_msgs__srv__Spawn_Request * ros_message = _ros_message;
  {  // x
...
PyObject * eyantrasim_msgs__srv__spawn__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eyantrasim_msgs.srv._spawn");
...
ROSIDL_GENERATOR_C_EXPORT
bool eyantrasim_msgs__srv__spawn__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eyantrasim_msgs.srv._spawn.Spawn_Response", full_classname_dest, 41) == 0);
  }
  eyantrasim_msgs__srv__Spawn_Response * ros_message = _ros_message;
  {  // name
    PyObject * field = PyObject_GetAttrString(_pymsg, "name");
    if (!field) {
      return false;
