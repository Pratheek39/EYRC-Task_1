...
class Metaclass_TeleportRelative(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.srv.TeleportRelative')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from eyantrasim_msgs.srv import _teleport_relative
...
class TeleportRelative(metaclass=Metaclass_TeleportRelative):
    from eyantrasim_msgs.srv._teleport_relative import TeleportRelative_Request as Request
    from eyantrasim_msgs.srv._teleport_relative import TeleportRelative_Response as Response
