...
class Metaclass_Kill(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from eyantrasim_msgs.srv import _kill
...
class Kill(metaclass=Metaclass_Kill):
    from eyantrasim_msgs.srv._kill import Kill_Request as Request
    from eyantrasim_msgs.srv._kill import Kill_Response as Response
