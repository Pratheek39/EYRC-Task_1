...
class Metaclass_SetPen(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from eyantrasim_msgs.srv import _set_pen
...
class SetPen(metaclass=Metaclass_SetPen):
    from eyantrasim_msgs.srv._set_pen import SetPen_Request as Request
    from eyantrasim_msgs.srv._set_pen import SetPen_Response as Response
