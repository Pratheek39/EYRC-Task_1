...
class Metaclass_Spawn(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from eyantrasim_msgs.srv import _spawn
...
class Spawn(metaclass=Metaclass_Spawn):
    from eyantrasim_msgs.srv._spawn import Spawn_Request as Request
    from eyantrasim_msgs.srv._spawn import Spawn_Response as Response
