...
class Metaclass_TeleportAbsolute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.srv.TeleportAbsolute')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from eyantrasim_msgs.srv import _teleport_absolute
...
class TeleportAbsolute(metaclass=Metaclass_TeleportAbsolute):
    from eyantrasim_msgs.srv._teleport_absolute import TeleportAbsolute_Request as Request
    from eyantrasim_msgs.srv._teleport_absolute import TeleportAbsolute_Response as Response
