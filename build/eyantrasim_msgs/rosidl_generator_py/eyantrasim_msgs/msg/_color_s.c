...
bool eyantrasim_msgs__msg__color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eyantrasim_msgs.msg._color.Color", full_classname_dest, 32) == 0);
  }
  eyantrasim_msgs__msg__Color * ros_message = _ros_message;
  {  // r
...
PyObject * eyantrasim_msgs__msg__color__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eyantrasim_msgs.msg._color");
