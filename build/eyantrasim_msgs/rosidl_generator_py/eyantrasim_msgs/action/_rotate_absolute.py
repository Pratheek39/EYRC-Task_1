...
class Metaclass_RotateAbsolute_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('eyantrasim_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.action.RotateAbsolute_Goal')
            logger.debug(
...
class Metaclass_RotateAbsolute_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.action.RotateAbsolute_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_RotateAbsolute_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.action.RotateAbsolute_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_RotateAbsolute_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from eyantrasim_msgs.action import RotateAbsolute
...
class RotateAbsolute_SendGoal_Request(metaclass=Metaclass_RotateAbsolute_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'eyantrasim_msgs/RotateAbsolute_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['eyantrasim_msgs', 'action'], 'RotateAbsolute_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_Goal
...
class Metaclass_RotateAbsolute_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.action.RotateAbsolute_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from eyantrasim_msgs.action import _rotate_absolute
...
class RotateAbsolute_SendGoal(metaclass=Metaclass_RotateAbsolute_SendGoal):
    from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_SendGoal_Request as Request
    from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_SendGoal_Response as Response
...
class RotateAbsolute_GetResult_Response(metaclass=Metaclass_RotateAbsolute_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'eyantrasim_msgs/RotateAbsolute_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['eyantrasim_msgs', 'action'], 'RotateAbsolute_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_Result
...
class Metaclass_RotateAbsolute_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.action.RotateAbsolute_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RotateAbsolute_GetResult(metaclass=Metaclass_RotateAbsolute_GetResult):
    from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_GetResult_Request as Request
    from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_GetResult_Response as Response
...
class Metaclass_RotateAbsolute_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.action.RotateAbsolute_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RotateAbsolute_FeedbackMessage(metaclass=Metaclass_RotateAbsolute_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'eyantrasim_msgs/RotateAbsolute_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['eyantrasim_msgs', 'action'], 'RotateAbsolute_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_Feedback
...
class Metaclass_RotateAbsolute(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'eyantrasim_msgs.action.RotateAbsolute')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RotateAbsolute(metaclass=Metaclass_RotateAbsolute):
    ...
    from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_Goal as Goal
    # The result message defined in the action definition.
    from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_Result as Result
    # The feedback message defined in the action definition.
    from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from eyantrasim_msgs.action._rotate_absolute import RotateAbsolute_FeedbackMessage as FeedbackMessage
