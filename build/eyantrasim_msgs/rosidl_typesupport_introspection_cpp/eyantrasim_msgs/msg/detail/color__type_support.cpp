...
{
  new (message_memory) eyantrasim_msgs::msg::Color(_init);
}

void Color_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eyantrasim_msgs::msg::Color *>(message_memory);
  typed_message->~Color();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Color_message_member_array[3] = {
  {
    ...
    offsetof(eyantrasim_msgs::msg::Color, r),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eyantrasim_msgs::msg::Color, g),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eyantrasim_msgs::msg::Color, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Color_message_members = {
  ...
  "Color",  // message name
  3,  // number of fields
  sizeof(eyantrasim_msgs::msg::Color),
...
get_message_type_support_handle<eyantrasim_msgs::msg::Color>()
{
  return &::eyantrasim_msgs::msg::rosidl_typesupport_introspection_cpp::Color_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eyantrasim_msgs, msg, Color)() {
  return &::eyantrasim_msgs::msg::rosidl_typesupport_introspection_cpp::Color_message_type_support_handle;
}
