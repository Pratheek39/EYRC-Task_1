...
#include "hb_interfaces/msg/detail/pose2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Pose2D__ros_msg_type = hb_interfaces__msg__Pose2D;
...
static uint32_t _Pose2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hb_interfaces__msg__Pose2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hb_interfaces__msg__Pose2D;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
static size_t _Pose2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hb_interfaces__msg__Pose2D(
